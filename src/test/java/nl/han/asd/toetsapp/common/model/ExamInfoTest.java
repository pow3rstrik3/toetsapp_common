...
public class ExamInfoTest {
    ...
    public void getJSONObjectWithoutPlugins() throws Exception {
        ...
        final ExamInfo baseExamInfo = new ExamInfo(id, version, title, subject, isMock);
        ...
        assertEquals("ExamInfo converted to JSON and back should keep the same subject.", subject, jsonExamInfo.getSubject());
    ...
    public void getJSONObjectWithPlugins() throws Exception {
        ...
        ExamInfo baseExamInfo = new ExamInfo(id, version, title, subject, isMock);
